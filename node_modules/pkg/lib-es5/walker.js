...
var Walker = function () {
  ...
  (0, _createClass3.default)(Walker, [{
    key: 'appendSub',
    value: function appendSub(task) {
      var file = task.file,
          marker = task.marker;

      (0, _assert2.default)(!this.records[file]);
      var record = this.records[file] = { file: file };
      if (marker) record.marker = marker;
      if (task.reason) {
        _log.log.debug('File %1 added to queue. It was required from %2', [task.file, task.reason]);
      } else {
        _log.log.debug('File %1 added to queue', [task.file]);
      }
    }
  }, {
    key: 'append',
    value: function append(task) {
      ...
      var record = this.records[task.file];
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(marker) {
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(record, derivatives) {
        var marker, config, base, name, d, dependencies, dependency, pkgConfig, patches, key, p, deployFiles, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, deployFile;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                for (_iterator5 = (0, _getIterator3.default)(deployFiles); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                  ...
                  _log.log.warn('Cannot include file %1 into executable.', ['The file must be distributed with executable as %2.', _path2.default.join(base, deployFile[0]), 'path-to-executable/' + deployFile[1]]);
                }
                _context2.next = 28;
                break;
    ...
    value: function stepDetect(record, derivatives) {
      ...
      try {
        _detector2.default.detect(body, function (node, trying) {
          var toplevel = record.marker.toplevel;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 8:
                ...
                toplevel = record.marker.toplevel;
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                catcher.packageFilter = function (config, base) {
                  ...
                  newMarker = { config: config, base: base };
                  stage = 2;
                  return config;
                };
    ...
    key: 'step_STORE_ANY',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(record, store) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 16:
                ...
                if (record.marker.permissive || record.marker.hasDictionary) {
                  this.append({
                    file: record.file,
                    marker: record.marker,
                    store: _common.STORE_CONTENT
      ...
      function step_STORE_ANY(_x11, _x12) {
    ...
    key: 'step',
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(task) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                _context9.next = 5;
                return this.step_STORE_ANY(record, store);
    ...
    key: 'start',
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(marker, entrypoint, addition) {
        var tasks, i;
